...
async function startnaimi() {
    ...
    console.log(color('[FELIX MD]', 'cyan'), color(`
Welcome Lord Fajar! `, 'red'))
console.log(color('[FELIX MD]', 'cyan'), color('OWNER SEDANG ONLINE SEKARANG!', 'yellow'))

	console.log(color('[FELIX MD]', 'cyan'), color('SELAMAT DATANG OWNER ><', 'yellow'))
	
	console.log(color('======================', 'fuchsia'),color('\n[FELIX MD V1]', 'pink'),color('\nTHANKS TO: \n➸ ALLAH SWT\n➸ Dika Ardnt.\nPenyedia scrape dan module lainnya', 'yellow'),color('\n======================', 'fuchsia'))
	console.log(color('\nADA SARAN ATAU MASUKAN WA : +6281333782061', 'red'))
    store.bind(naimi.ev)
...
mediaType:2,
thumbnail: ppusernya,
sourceUrl: `https://www.instagram.com/mhmdfjralfarizi_`,
